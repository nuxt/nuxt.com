...
<template>
  <div class="relative size-full overflow-hidden bg-[#010B18] py-8">
    <div
      aria-hidden="true"
    ...
    <div class="relative flex size-full flex-col justify-between">
      <div />
      <div class="mx-auto">
        <p v-if="headline" class="mb-2 flex justify-center text-[24px] font-semibold text-[#00DC82]">
          {{ headline }}
        </p>
        <h1 class="m-0 mb-2 flex max-w-[950px] justify-center text-center text-[75px] font-semibold text-white">
          {{ title }}
        </h1>
        <p v-if="description" class="max-w-[900px] text-center text-[32px] text-[#B6B6B6]">
