...
<template>
  <div class="size-full relative flex flex-col justify-center items-center bg-[#020420] py-8">
    <img
    ...
    <div class="relative flex flex-col items-center justify-center">
      ...
      <h1 class="text-6xl font-semibold text-white mb-4 max-w-[950px]">
        {{ title }}
      </h1>
      <p v-if="description" class="text-3xl leading-relaxed text-center text-slate-400 max-w-[850px]" :style="{ lineClamp: 2, textOverflow: 'ellipsis' }">
        {{ description }}
      </p>
    </div>
