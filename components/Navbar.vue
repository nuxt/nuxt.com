    ...
    <div class="container">
      ...
      >
        ...
        <div class="flex justify-end">
          <AlgoliaDocSearch
            v-show="$route.fullPath.startsWith('/docs')"
...
const dropdownLinks = [
  {
    ...
    to: 'https://nuxt.new/?utm_source=nuxt-com&utm_medium=dropdown&utm_campaign=home'
  },
  {
    title: 'Nuxters',
    description: 'Are you a Nuxter?',
    to: 'https://nuxters.nuxt.com/?utm_source=nuxt-com&utm_medium=dropdown&utm_campaign=home'
  }
