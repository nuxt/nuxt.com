...
<template>
  <div class="relative w-full bg-white dark:bg-black z-50 border-b border-b-gray-300 dark:border-b-gray-700 template-banner">
    <div class="flex flex-wrap justify-center items-center gap-2 p-2 w-4/5 mx-auto">
      <NuxtLink to="https://certification.vuejs.org/?friend=NUXT" target="_blank" class="text-sm text-center items-center text-black dark:text-white justify-center">
        <span class="font-semibold">
          🎓 Official Vue.js Certification
        </span>
        - The official certification of competence for the Vue.js Framework is out.
      </NuxtLink>
      <NuxtLink to="https://certification.vuejs.org/?friend=NUXT" target="_blank" class="inline-flex items-center px-2 py-1 font-medium text-xs border rounded border-gray-400 hover:border-gray-600 dark:border-gray-700 dark:hover:border-gray-500 hover:bg-gray-100 dark:hover:bg-gray-900">
        <span>Discover</span>
