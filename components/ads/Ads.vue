<template>
  <div class="space-y-3">
    <LazyClientOnly>
      <NuxtLink :to="adPartner._path" class="flex items-center bg-background dark:hover:bg-gray-800/50 hover:bg-gray-100 rounded-lg h-[60px] p-4 lg:p-2 align-middle border border-gray-200 dark:border-gray-800 truncate">
      ...
      <NuxtLink to="https://masteringnuxt.com/nuxt3?ref=nuxt" target="_blank" class="gap-1 p-4 lg:p-2 dark:hover:bg-gray-800/50 hover:bg-gray-100 flex flex-col items-start justify-between bg-background rounded-lg border border-gray-200 dark:border-gray-800">
      ...
      <NuxtLink to="/enterprise/jobs" class="relative p-4 lg:p-2 dark:hover:bg-gray-800/50 hover:bg-gray-100 flex items-center justify-between bg-background rounded-lg h-[60px] border border-gray-200 dark:border-gray-800">
