<template>
  <li class="relative col-span-6 overflow-hidden border u-border-gray-200 rounded-xl h-44 group">
    ...
    <img :src="`https://github.com/${nuxter.github}.png`" :alt="nuxter.github" class="absolute w-56 h-56 transition-all rounded-full -top-6 -left-10 grayscale group-hover:grayscale-0">
