<template>
  <li class="relative col-span-6 overflow-hidden border xl:col-span-3 u-border-gray-200 rounded-xl h-44 group">
    ...
    <img :src="`https://github.com/${nuxter.github}.png`" :alt="nuxter.github" class="absolute w-48 h-48 transition-all rounded-full -top-2 -left-14 grayscale group-hover:grayscale-0">
