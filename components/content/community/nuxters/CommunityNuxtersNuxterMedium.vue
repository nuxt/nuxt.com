<template>
  <li class="relative col-span-3 overflow-hidden border u-border-gray-200 rounded-xl h-44 group">
    <img src="/assets/community/nuxters/nuxter-gradient.svg" alt="nuxter background" class="absolute object-cover transition-all duration-200 h-44 left-20 grayscale group-hover:grayscale-0">
    <img :src="`https://github.com/${nuxter.github}.png`" :alt="nuxter.github" class="absolute w-48 h-48 transition-all duration-200 rounded-full -top-2 -left-14 grayscale group-hover:grayscale-0">
