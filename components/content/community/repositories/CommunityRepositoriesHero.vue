<template>
  <PageHero>
    ...
    <template #extra>
      <CommunityRepositoriesFilterSearch class="hidden md:block" />
    </template>

    <template #image>
      <img src="/assets/community/repositories/gems.svg" class="object-contain h-full lg:mx-10 opacity-10 lg:opacity-100">
