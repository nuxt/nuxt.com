<template>
  <div class="relative not-prose">
    ...
    <img src="/docs/framework/v2/gems.png" class="absolute right-0 opacity-20 lg:opacity-100 h-1/5 top-48" alt="Gem illustration">
    <div class="relative flex flex-col items-center justify-center pb-48 gap-y-8 pt-36 md:pt-44 lg:pb-56 lg:pt-36">
      ...
      <h1 v-if="$slots.title" class="max-w-lg text-5xl font-bold text-center sm:text-7xl u-text-gray-900">
