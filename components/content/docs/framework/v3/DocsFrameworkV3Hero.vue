<template>
  <div class="relative flex flex-row items-center justify-between pb-48 pt-36 md:pt-44 lg:pb-56 lg:pt-36 gap-x-4">
    <div class="flex flex-col items-center lg:items-start gap-y-8">
      ...
      <h1 v-if="$slots.title" class="max-w-xl font-bold text-center lg:text-left text-7xl u-text-gray-900">
        <Markdown :use="$slots.title" unwrap="p" />
      </h1>
      <p v-if="$slots.description" class="w-1/2 text-lg text-center lg:text-left u-text-gray-500">
