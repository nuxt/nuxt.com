<template>
  <div class="relative">
    ...
    <div class="absolute top-[52px] left-[54px] u-text-gray-400">
      <span class="absolute transition-opacity duration-300" :class="step !== 1 ? 'opacity-100' : 'opacity-0'">pages</span>
      <span class="absolute transition-opacity duration-300" :class="step === 1 ? 'opacity-100' : 'opacity-0'">components</span>
    </div>
    <div class="absolute top-[100px] left-[88px] u-text-white">
      <span class="absolute transition-opacity duration-300" :class="step !== 1 ? 'opacity-100' : 'opacity-0'">index.vue</span>
      <span class="absolute transition-opacity duration-300" :class="step === 1 ? 'opacity-100' : 'opacity-0'">Mouse.vue</span>
    </div>
    <div class="absolute top-[47%] left-[52px] u-text-gray-400">
      <span class="absolute transition-opacity duration-300" :class="step === 0 ? 'opacity-100' : 'opacity-0'">components</span>
      <span class="absolute transition-opacity duration-300" :class="step === 1 ? 'opacity-100' : 'opacity-0'">composables</span>
      <span class="absolute transition-opacity duration-300" :class="step === 2 ? 'opacity-100' : 'opacity-0'">plugins</span>
    </div>
    <div class="absolute top-[218px] left-[88px] u-text-gray-400">
      <span class="absolute transition-opacity duration-300" :class="step === 0 ? 'opacity-100' : 'opacity-0'">header.vue</span>
      <span class="absolute transition-opacity duration-300" :class="step === 1 ? 'opacity-100' : 'opacity-0'">useMouse.js</span>
      <span class="absolute transition-opacity duration-300" :class="step === 2 ? 'opacity-100' : 'opacity-0'">global.js</span>
    </div>
    <div class="absolute top-[260px] left-[88px] u-text-gray-400 transition-opacity duration-300" :class="step === 0 ? 'opacity-100' : 'opacity-0'">
      footer.vue
    </div>
    <img
    ...
    >
    <DocsFrameworkV3AutoImportComponentsScript class="absolute left-[250px] top-1/2" :current-section="step" />
    <DocsFrameworkV3AutoImportComposablesMouse class="absolute left-[250px] top-[62px]" :current-section="step" />
    <DocsFrameworkV3AutoImportPluginsTemplate class="absolute left-[250px] top-[62px]" :current-section="step" />
    <img
