<template>
  <div>
    <div class="absolute -right-[120px] top-4 transition-colors duration-300" :class="[1, 2, 8, 9].includes(currentSection) ? 'u-text-gray-600' : 'u-text-gray-900'">
      ...
      <span class="absolute top-[60%] left-4 u-text-gray-500 tracking-wide font-mono transition-opacity duration-300" :class="[4, 5, 11, 12].includes(currentSection) ? 'opacity-0' : 'opacity-100'">
        Waiting to compile ...
      </span>
    </div>
    <img
      src="/docs/framework/v3/auto-import/terminal.svg"
      class="absolute -right-[120px] top-4 w-[308px] h-[126px] transition-opacity duration-300"
