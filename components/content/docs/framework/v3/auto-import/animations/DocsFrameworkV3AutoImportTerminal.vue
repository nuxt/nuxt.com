<template>
  <div>
    <div class="absolute -right-[120px] top-4 transition-colors duration-300" :class="[1, 2, 8, 9].includes(currentSection) ? 'text-gray-600' : 'text-gray-900'">
      <svg
        width="308"
        height="126"
        viewBox="0 0 308 126"
      ...
      <span class="absolute top-[60%] left-4 text-gray-500 tracking-wide font-mono transition-opacity duration-300" :class="[4, 5, 11, 12].includes(currentSection) ? 'opacity-100' : 'opacity-0'">
        ...
      </span>
      <span class="absolute top-[60%] left-4 text-gray-500 tracking-wide font-mono transition-opacity duration-300" :class="[4, 5, 11, 12].includes(currentSection) ? 'opacity-0' : 'opacity-100'">
        Waiting to compile ...
      </span>
    </div>
    <img
