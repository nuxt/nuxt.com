...
<div class="relative w-[701px] h-[415px]">
  ...
  <div class="relative w-[701px] h-[415px] bg-gray-100 dark:bg-gray-900 rounded-lg flex items-center shadow-xl backdrop-blur-sm bg-opacity-50 ">
    ...
    <div
      class="absolute inset-0 flex flex-col items-center justify-center space-y-4 transition-opacity duration-300"
    ...
    >
      ...
      >
        <div class="flex flex-col gap-y-[18px] pl-[28px] pt-7">
          ...
          <div class="w-[185px] h-[61px] rounded-xl" :class="dashboardHovered || messageHovered ? 'bg-green-200' : 'bg-gray-200'" />
          <div class="w-[185px] h-[61px] rounded-xl" :class="dashboardHovered || messageHovered ? 'bg-green-200' : 'bg-gray-200'" />
        </div>
        <div
          class="w-full mt-7 rounded-tl-xl ml-[25px] grid grid-cols-2 px-[53px] py-[80px]"
