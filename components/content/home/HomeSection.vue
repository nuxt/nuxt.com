<template>
  ...
  >
    ...
    <div v-if="buttons.length" class="gap-2 lg:gap-6 pt-8" :class="sectionAlign === 'row' ? 'inline-flex lg:flex lg:flex-col lg:flex-row lg:justify-end lg:pt-0 lg:w-1/3' : 'inline-flex justify-center lg:pt-12'">
      <UButton
