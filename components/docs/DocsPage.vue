<template>
  <section class="relative flex flex-col-reverse gap-8 lg:grid lg:grid-cols-10">
    <div
      v-if="toc"
      class="z-50 lg:z-0 lg:col-span-2 lg:self-start overflow-x-hidden sticky top-16 -mx-4 sm:-mx-6 px-4 sm:px-6 lg:mx-0 lg:px-0 lg:pt-8 lg:-mt-8 bg-white/75 dark:bg-black/75 backdrop-blur-md lg:max-h-[calc(100vh-64px)] order-1"
    >
