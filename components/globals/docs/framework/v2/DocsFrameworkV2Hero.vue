<template>
  <div class="not-prose relative">
    ...
    <div class="flex flex-col items-center justify-center pb-48 gap-y-8 pt-36 md:pt-44 lg:pb-56 lg:pt-36 relative">
      ...
      <h1 v-if="$slots.title" class="font-bold text-5xl sm:text-7xl text-center u-text-gray-900 max-w-lg">
        <Markdown use="title" unwrap="p" />
      </h1>
      <p v-if="$slots.description" class="sm:w-1/2 text-md sm:text-lg text-center u-text-gray-500">
