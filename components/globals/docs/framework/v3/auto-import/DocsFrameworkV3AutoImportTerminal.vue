<template>
  <div>
    <div class="absolute -right-[50px] top-4 transition-colors duration-300" :class="currentStep === 1 || currentStep === 6 ? 'u-text-gray-600' : 'u-text-gray-900'">
      ...
      <span class="absolute top-[38%] left-4 text-green-400 font-mono transition-opacity duration-300" :class="[3, 4, 8, 9].includes(currentStep) ? 'opacity-0' : 'opacity-100'">
        Compiled successfully
      </span>

      <span class="absolute top-[38%] left-4 text-green-400 font-mono transition-opacity duration-300" :class="[0, 1, 2, 4, 5, 6, 7, 9, 10].includes(currentStep) ? 'opacity-0' : 'opacity-100'">
        Compilation 0%
      </span>

      <span class="absolute top-[38%] left-4 text-green-400 font-mono transition-opacity duration-300" :class="[0, 1, 2, 3, 5, 6, 7, 8, 10].includes(currentStep) ? 'opacity-0' : 'opacity-100'">
        Compilation 100%
      </span>

      <span class="absolute top-[60%] left-4 u-text-gray-500 tracking-wide font-mono transition-opacity duration-300" :class="[3, 4, 9, 10].includes(currentStep) ? 'opacity-100' : 'opacity-0'">
        ...
      </span>
      <span class="absolute top-[60%] left-4 absolute u-text-gray-500 tracking-wide font-mono transition-opacity duration-300" :class="[3, 4, 9, 10].includes(currentStep) ? 'opacity-0' : 'opacity-100'">
        Waiting to compile ...
      </span>
    </div>
    <img
      ...
      :class="currentStep === 1 || currentStep === 6 ? 'opacity-80' : 'opacity-0'"
    >
  </div>
</template>
...
onMounted(() => startStepper([600, 1200, 600, 600, 600, 1200, 1200, 600, 600, 600, 1200]))
