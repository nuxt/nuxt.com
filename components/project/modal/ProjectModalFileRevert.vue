<template>
  <UModal v-model="isOpen" appear @close="onClose" @submit.prevent="onSubmit">
    <div class="sm:flex sm:items-start">
      <div class="flex items-center justify-center flex-shrink-0 w-12 h-12 mx-auto rounded-full bg-orange-50 dark:bg-orange-400 sm:mx-0 sm:h-10 sm:w-10">
        <svg
    ...
    <div class="gap-3 mt-5 sm:mt-6 sm:flex sm:flex-row-reverse">
      <UButton type="submit" label="Revert" variant="orange" class="justify-center flex-shrink-0 w-full sm:w-auto" />
