<template>
  <UCard body-class="p-12 text-center">
    ...
    <div class="-mx-12 sm:mx-0 grid sm:gap-6 sm:grid-cols-2 lg:grid-cols-4 my-6">
      <TemplateCard
    ...
    <ULink to="/new/templates" class="text-sm u-text-gray-900 hover:underline block mt-3">
