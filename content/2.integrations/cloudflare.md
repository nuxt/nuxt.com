...
**Preset:** `cloudflare` ([switch to this preset](https://nitro.unjs.io/deploy/#changing-the-deployment-preset))
...
**Preset:** `cloudflare_pages` ([switch to this preset](https://nitro.unjs.io/deploy/#changing-the-deployment-preset))
...
**Preset:** `cloudflare_module` ([switch to this preset](https://nitro.unjs.io/deploy/#changing-the-deployment-preset))
...
::callout{color="green" icon="i-ph-info"}
