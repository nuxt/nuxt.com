...
We've landed a raft of changes to enable local modules and improve DX. We now auto-scan your `~/modules` folder and register top level files there as modules in your project ([#19394](https://github.com/nuxt/nuxt/pull/19394)). When these files are changed, we'll automatically restart the nuxt server.
...
See the full changelog by [comparing the changes](https://github.com/nuxt/nuxt/compare/v3.2.3...v3.3.0)
...
### 🏡 Chore
  ...
  - **deps:** ⚠️  Update dependency fork-ts-checker-webpack-plugin to v8 (main) ([#19468](https://github.com/nuxt/nuxt/pull/19468))
...
- Özüm Eldoğan ([@ozum](http://github.com/ozum))
