...
This [migration](https://github.com/nuxt/nuxt.com/pull/1365) was a great opportunity to improve Nuxt UI & UI Pro and fix some bugs, as well a difference of [+8,964]{.text-green-500} / [-23,111]{.text-red-500} lines of code changed.

## OG Images

We are a big of of having different images when we share a link on social media, that's why we have added OG images on all our documentation pages.
