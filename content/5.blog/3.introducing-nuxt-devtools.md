...
This might be considered as a trade-off of any tools, you have to learn and understand the tool to use it with efficienty. Despite  improving the documentation and providing more examples, **we believe of an opportunity to improve the lack of transparency**.
...
DevTools is composed of multiple tabs for different aspects of your app.
...
![devtools-tab-pages](/assets/blog/devtools/tab-pages.png)
...
![devtools-tab-components](/assets/blog/devtools/tab-components.png)
