...
::alert{type="next"}
To learn more about how to move from @nuxtjs/dotenv to runtime config check out [this article](https://v2.nuxt.com/tutorials/moving-from-nuxtjs-dotenv-to-runtime-config).
::
