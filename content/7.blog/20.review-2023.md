...
- **26,300 members** :icon{name="i-simple-icons-disco"} on [Discord]()\:icon
...
I'm really delighted to see successful businesses founded on Nuxt, and initiatives springing up around Nuxt that are sponsoring or otherwise giving back to the core framework, enabling ongoing Nuxt development.

Obviously [NuxtLabs](https://nuxtlabs.com/) is the preeminent example of that, led by Sébastien Chopin - and much of their sponsorship of developers in the Nuxt ecosystem comes from their paid initiatives, such as [Nuxt UI Pro](https://ui.nuxt.com/pro/getting-started), [Nuxt Studio](https://nuxt.studio/), [NuxtHub](https://hub.nuxt.com/) and more.
...
Roughly speaking, we're aiming to have one more minor release for Nuxt v3, before 
