...
The Shikiji rewrite seems to worked quite well, we have many tools like [Nuxt Content](https://github.com/nuxt/content), [VitePress](https://vitepress.dev/), [Astro](https://astro.build/) migrated to it, and the feedbacks are very positive.
