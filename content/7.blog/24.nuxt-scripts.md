...
Third-party scripts are so widespread because are fundamentally useful. We know that they aren't perfect, but they don't
...
This slows down the network and blocking the main thread, leading to a degraded user experience and poor [Core Web Vitals](https://web.dev/vitals/).
...
In many cases we're loaded third-party scripts from a domain that we don't control. This can lead to a number of issues:
