...
|----------------------------------| -------- | ----------------------------------------------------------- |
| :code[primary]{.text-green-400}  | `green`  | Main brand color, used as the default color for components. |
| :code[secondary]{.text-blue-400} | `blue`   | Secondary color to complement the primary color.            |
| :code[success]{.text-green-400}  | `green`  | Used for success states.                                    |
| :code[info]{.text-blue-400}      | `blue`   | Used for informational states.                              |
| :code[warning]{.text-yellow-400} | `yellow` | Used for warning states.                                    |
| :code[error]{.text-red-400}      | `red`    | Used for form error validation states.                      |
