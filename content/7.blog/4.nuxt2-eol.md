...
description: "Nuxt 2 will reach End of Life (EOL) on June 30, 2024. We've partnered with HeroDevs on offering Never-Ending Support (NES)."
...
<!--
On June 30, the following packages will be marked as deprecated on NPM:
- `nuxt@v2`
-->

::note
Vue 2 reached its end-of-life date of December 31, 2023.
::
    
## What’s Next?

Nuxt 3 has been the default version of Nuxt since November 16, 2022.
...
It is with a heavy heart that I am saying goodbye to Nuxt 2, after many years of working on it and seing so many websites made with it, this famous loading bar at the top of each Nuxt 2 websites will something I will miss a lot! It is with full of energy and excitement that I will keep working with the core team on the future of Nuxt to keep innovating like we've been doing the past 8 years.
