...
The API endpoint uses Nuxt Content's [`queryCollection`](https://content.nuxt.com/docs/utils/query-collection) to fetch the documentation pages:
...
Notice the caching strategy, this ensures fast responses while keeping content fresh. Read more about [`defineCachedEventHandler`](https://nitro.build/guide/cache#cached-event-handlers) in the Nitro documentation.
...
::note
We are currently working on a Nuxt MCP module to help you create an MCP server using your directory structure. Stay tuned!
::
...
The complete source code for our MCP server is available on [GitHub](https://github.com/nuxt/nuxt.com) in the [`server/routes/mcp.ts`](https://github.com/nuxt/nuxt.com/tree/main/server/routes/mcp.ts) file and [`server/api/mcp/`](https://github.com/nuxt/nuxt.com/tree/main/server/api/mcp) directory. Feel free to use it as inspiration for your own implementation!
