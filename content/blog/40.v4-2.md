...
You can now pass an `AbortController` signal directly to `useAsyncData` and `useFetch`, giving you fine-grained control over request cancellation ([#32531](https://github.com/nuxt/nuxt/pull/32531)).
...
For those wanting to experiment with cutting-edge features, you can now opt into the Vite Environment API ([#33492](https://github.com/nuxt/nuxt/pull/33492)).
