...
export const createTheme = (emotion: Emotion, manager: ThemeManager, colorSet: ColorSet) => {
  const { css } = emotion
...
export const dark = getTheme(darkColors)
export const light = getTheme(lightColors)
