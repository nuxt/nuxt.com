...
export default defineNuxtConfig({
  ...
  routeRules: {
    ...
    '/docs/5.x/directory-structure/app': { redirect: '/docs/5.x/directory-structure/app/app', prerender: false },
    '/docs/3.x/guide/directory-structure/**': { redirect: '/docs/3.x/directory-structure', prerender: false },
    ...
    '/docs/5.x/guide/directory-structure/assets': { redirect: '/docs/5.x/directory-structure/app/assets', prerender: false },
    ...
    '/docs/5.x/guide/directory-structure/components': { redirect: '/docs/5.x/directory-structure/app/components', prerender: false },
    ...
    '/docs/5.x/guide/directory-structure/composables': { redirect: '/docs/5.x/directory-structure/app/composables', prerender: false },
    ...
    '/docs/5.x/guide/directory-structure/layouts': { redirect: '/docs/5.x/directory-structure/app/layouts', prerender: false },
    ...
    '/docs/5.x/guide/directory-structure/middleware': { redirect: '/docs/5.x/directory-structure/app/middleware', prerender: false },
    ...
    '/docs/5.x/guide/directory-structure/pages': { redirect: '/docs/5.x/directory-structure/app/pages', prerender: false },
    ...
    '/docs/5.x/guide/directory-structure/plugins': { redirect: '/docs/5.x/directory-structure/app/plugins', prerender: false },
    ...
    '/docs/5.x/guide/directory-structure/utils': { redirect: '/docs/5.x/directory-structure/app/utils', prerender: false },
    '/docs/4.x/guide/directory-structure/app': { redirect: '/docs/4.x/directory-structure/app/app', prerender: false },
    '/docs/5.x/guide/directory-structure/app': { redirect: '/docs/5.x/directory-structure/app/app', prerender: false },
    ...
    '/docs/5.x/guide/guide/directory-structure/app-config': { redirect: '/docs/5.x/directory-structure/app/app-config', prerender: false },
    ...
    '/docs/5.x/guide/directory-structure/error': { redirect: '/docs/5.x/directory-structure/app/error', prerender: false },
    ...
    '/docs/5.x/guide/directory-structure/nuxt': { redirect: '/docs/5.x/directory-structure/nuxt', prerender: false },
    '/docs/4.x/guide/directory-structure/output': { redirect: '/docs/4.x/directory-structure/output', prerender: false },
    '/docs/5.x/guide/directory-structure/output': { redirect: '/docs/5.x/directory-structure/output', prerender: false },
    '/docs/4.x/guide/directory-structure/app/assets': { redirect: '/docs/4.x/directory-structure/app/assets', prerender: false },
    '/docs/5.x/guide/directory-structure/app/assets': { redirect: '/docs/5.x/directory-structure/app/assets', prerender: false },
    '/docs/4.x/guide/directory-structure/app/components': { redirect: '/docs/4.x/directory-structure/app/components', prerender: false },
    '/docs/5.x/guide/directory-structure/app/components': { redirect: '/docs/5.x/directory-structure/app/components', prerender: false },
    '/docs/4.x/guide/directory-structure/app/composables': { redirect: '/docs/4.x/directory-structure/app/composables', prerender: false },
    '/docs/5.x/guide/directory-structure/app/composables': { redirect: '/docs/5.x/directory-structure/app/composables', prerender: false },
    '/docs/4.x/guide/directory-structure/app/layouts': { redirect: '/docs/4.x/directory-structure/app/layouts', prerender: false },
    '/docs/5.x/guide/directory-structure/app/layouts': { redirect: '/docs/5.x/directory-structure/app/layouts', prerender: false },
    '/docs/4.x/guide/directory-structure/app/middleware': { redirect: '/docs/4.x/directory-structure/app/middleware', prerender: false },
    '/docs/5.x/guide/directory-structure/app/middleware': { redirect: '/docs/5.x/directory-structure/app/middleware', prerender: false },
    '/docs/4.x/guide/directory-structure/app/pages': { redirect: '/docs/4.x/directory-structure/app/pages', prerender: false },
    '/docs/5.x/guide/directory-structure/app/pages': { redirect: '/docs/5.x/directory-structure/app/pages', prerender: false },
    '/docs/4.x/guide/directory-structure/app/plugins': { redirect: '/docs/4.x/directory-structure/app/plugins', prerender: false },
    '/docs/5.x/guide/directory-structure/app/plugins': { redirect: '/docs/5.x/directory-structure/app/plugins', prerender: false },
    '/docs/4.x/guide/directory-structure/app/utils': { redirect: '/docs/4.x/directory-structure/app/utils', prerender: false },
    '/docs/5.x/guide/directory-structure/app/utils': { redirect: '/docs/5.x/directory-structure/app/utils', prerender: false },
    '/docs/4.x/guide/directory-structure/app/app': { redirect: '/docs/4.x/directory-structure/app/app', prerender: false },
    '/docs/5.x/guide/directory-structure/app/app': { redirect: '/docs/5.x/directory-structure/app/app', prerender: false },
    '/docs/4.x/guide/directory-structure/app/app-config': { redirect: '/docs/4.x/directory-structure/app/app-config', prerender: false },
    '/docs/5.x/guide/directory-structure/app/app-config': { redirect: '/docs/5.x/directory-structure/app/app-config', prerender: false },
    '/docs/4.x/guide/directory-structure/app/error': { redirect: '/docs/4.x/directory-structure/app/error', prerender: false },
    '/docs/5.x/guide/directory-structure/app/error': { redirect: '/docs/5.x/directory-structure/app/error', prerender: false },
    '/docs/4.x/guide/directory-structure/content': { redirect: '/docs/4.x/directory-structure/content', prerender: false },
    '/docs/5.x/guide/directory-structure/content': { redirect: '/docs/5.x/directory-structure/content', prerender: false },
    '/docs/4.x/guide/directory-structure/modules': { redirect: '/docs/4.x/directory-structure/modules', prerender: false },
    '/docs/5.x/guide/directory-structure/modules': { redirect: '/docs/5.x/directory-structure/modules', prerender: false },
    '/docs/4.x/guide/directory-structure/node_modules': { redirect: '/docs/4.x/directory-structure/node_modules', prerender: false },
    '/docs/5.x/guide/directory-structure/node_modules': { redirect: '/docs/5.x/directory-structure/node_modules', prerender: false },
    '/docs/4.x/guide/directory-structure/public': { redirect: '/docs/4.x/directory-structure/public', prerender: false },
    '/docs/5.x/guide/directory-structure/public': { redirect: '/docs/5.x/directory-structure/public', prerender: false },
    '/docs/4.x/guide/directory-structure/server': { redirect: '/docs/4.x/directory-structure/server', prerender: false },
    '/docs/5.x/guide/directory-structure/server': { redirect: '/docs/5.x/directory-structure/server', prerender: false },
    '/docs/4.x/guide/directory-structure/shared': { redirect: '/docs/4.x/directory-structure/shared', prerender: false },
    '/docs/5.x/guide/directory-structure/shared': { redirect: '/docs/5.x/directory-structure/shared', prerender: false },
    '/docs/4.x/guide/directory-structure/env': { redirect: '/docs/4.x/directory-structure/env', prerender: false },
    '/docs/5.x/guide/directory-structure/env': { redirect: '/docs/5.x/directory-structure/env', prerender: false },
    '/docs/4.x/guide/directory-structure/gitignore': { redirect: '/docs/4.x/directory-structure/gitignore', prerender: false },
    '/docs/5.x/guide/directory-structure/gitignore': { redirect: '/docs/5.x/directory-structure/gitignore', prerender: false },
    '/docs/4.x/guide/directory-structure/nuxtignore': { redirect: '/docs/4.x/directory-structure/nuxtignore', prerender: false },
    '/docs/5.x/guide/directory-structure/nuxtignore': { redirect: '/docs/5.x/directory-structure/nuxtignore', prerender: false },
    '/docs/4.x/guide/directory-structure/nuxtrc': { redirect: '/docs/4.x/directory-structure/nuxtrc', prerender: false },
    '/docs/5.x/guide/directory-structure/nuxtrc': { redirect: '/docs/5.x/directory-structure/nuxtrc', prerender: false },
    '/docs/4.x/guide/directory-structure/nuxt-config': { redirect: '/docs/4.x/directory-structure/nuxt-config', prerender: false },
    '/docs/5.x/guide/directory-structure/nuxt-config': { redirect: '/docs/5.x/directory-structure/nuxt-config', prerender: false },
    '/docs/4.x/guide/directory-structure/package': { redirect: '/docs/4.x/directory-structure/package', prerender: false },
    '/docs/5.x/guide/directory-structure/package': { redirect: '/docs/5.x/directory-structure/package', prerender: false },
    '/docs/4.x/guide/directory-structure/tsconfig': { redirect: '/docs/4.x/directory-structure/tsconfig', prerender: false },
    '/docs/5.x/guide/directory-structure/tsconfig': { redirect: '/docs/5.x/directory-structure/tsconfig', prerender: false },
    ...
    '/docs/5.x/examples/essentials/hello-world': { redirect: '/docs/5.x/examples/hello-world', prerender: false },
    '/docs/4.x/api/composables/usehead': { redirect: '/docs/4.x/api/composables/use-head', prerender: false },
    '/docs/5.x/api/composables/usehead': { redirect: '/docs/5.x/api/composables/use-head', prerender: false },
    '/docs/4.x/examples/composables/use-async-data': { redirect: '/docs/4.x/examples/features/data-fetching', prerender: false },
    '/docs/5.x/examples/composables/use-async-data': { redirect: '/docs/5.x/examples/features/data-fetching', prerender: false },
    '/docs/4.x/examples/composables/use-head': { redirect: '/docs/4.x/examples/features/meta-tags', prerender: false },
    '/docs/5.x/examples/composables/use-head': { redirect: '/docs/5.x/examples/features/meta-tags', prerender: false },
    '/docs/4.x/getting-started/directory-structure': { redirect: '/docs/4.x/directory-structure', prerender: false },
    '/docs/5.x/getting-started/directory-structure': { redirect: '/docs/5.x/directory-structure', prerender: false },
    '/docs/4.x/guide/going-further/modules': { redirect: '/docs/4.x/guide/modules', prerender: false },
    '/docs/5.x/guide/going-further/modules': { redirect: '/docs/5.x/guide/modules', prerender: false },
    '/docs/4.x/guide/concepts/rendering-modes': { redirect: '/docs/4.x/guide/concepts/rendering', prerender: false },
    '/docs/5.x/guide/concepts/rendering-modes': { redirect: '/docs/5.x/guide/concepts/rendering', prerender: false },
    '/docs/4.x/guide/directory-structure/nuxt.config': { redirect: '/docs/4.x/directory-structure/nuxt-config', prerender: false },
    '/docs/5.x/guide/directory-structure/nuxt.config': { redirect: '/docs/5.x/directory-structure/nuxt-config', prerender: false },
    '/docs/4.x/getting-started/hooks': { redirect: '/docs/4.x/api/advanced/hooks', prerender: false },
    '/docs/5.x/getting-started/hooks': { redirect: '/docs/5.x/api/advanced/hooks', prerender: false },
    '/docs/4.x/api/nuxt-hooks': { redirect: '/docs/4.x/api/advanced/hooks', prerender: false },
    '/docs/5.x/api/nuxt-hooks': { redirect: '/docs/5.x/api/advanced/hooks', prerender: false },
    '/docs/4.x/guide/directory-structure/hooks': { redirect: '/docs/4.x/api/advanced/hooks', prerender: false },
    '/docs/5.x/guide/directory-structure/hooks': { redirect: '/docs/5.x/api/advanced/hooks', prerender: false },
