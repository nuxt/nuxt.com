...
export default defineNuxtConfig({
  ...
  routeRules: {
    ...
    '/docs/3.x/guide/directory-structure/assets': { redirect: '/docs/3.x/guide/directory-structure/app/assets', prerender: false },
    '/docs/4.x/guide/directory-structure/assets': { redirect: '/docs/4.x/guide/directory-structure/app/assets', prerender: false },
    '/docs/3.x/guide/directory-structure/components': { redirect: '/docs/3.x/guide/directory-structure/app/components', prerender: false },
    '/docs/4.x/guide/directory-structure/components': { redirect: '/docs/4.x/guide/directory-structure/app/components', prerender: false },
    '/docs/3.x/guide/directory-structure/composables': { redirect: '/docs/3.x/guide/directory-structure/app/composables', prerender: false },
    ...
    '/docs/3.x/guide/directory-structure/layouts': { redirect: '/docs/3.x/guide/directory-structure/app/layouts', prerender: false },
    '/docs/4.x/guide/directory-structure/layouts': { redirect: '/docs/4.x/guide/directory-structure/app/layouts', prerender: false },
    '/docs/3.x/guide/directory-structure/middleware': { redirect: '/docs/3.x/guide/directory-structure/app/middleware', prerender: false },
    '/docs/4.x/guide/directory-structure/middleware': { redirect: '/docs/4.x/guide/directory-structure/app/middleware', prerender: false },
    '/docs/3.x/guide/directory-structure/pages': { redirect: '/docs/3.x/guide/directory-structure/app/pages', prerender: false },
    '/docs/4.x/guide/directory-structure/pages': { redirect: '/docs/4.x/guide/directory-structure/app/pages', prerender: false },
    '/docs/3.x/guide/directory-structure/plugins': { redirect: '/docs/3.x/guide/directory-structure/app/plugins', prerender: false },
    '/docs/4.x/guide/directory-structure/plugins': { redirect: '/docs/4.x/guide/directory-structure/app/plugins', prerender: false },
    '/docs/3.x/guide/directory-structure/utils': { redirect: '/docs/3.x/guide/directory-structure/app/utils', prerender: false },
    '/docs/4.x/guide/directory-structure/utils': { redirect: '/docs/4.x/guide/directory-structure/app/utils', prerender: false },
    '/docs/3.x/guide/directory-structure/app': { redirect: '/docs/3.x/guide/directory-structure/app/app', prerender: false },
    '/docs/4.x/guide/directory-structure/app': { redirect: '/docs/4.x/guide/directory-structure/app/app', prerender: false },
    '/docs/3.x/guide/directory-structure/app-config': { redirect: '/docs/3.x/guide/directory-structure/app/app-config', prerender: false },
    '/docs/4.x/guide/directory-structure/app-config': { redirect: '/docs/4.x/guide/directory-structure/app/app-config', prerender: false },
    '/docs/3.x/guide/directory-structure/error': { redirect: '/docs/3.x/guide/directory-structure/app/error', prerender: false },
