...
const { draft, file, getFile, openCreateModal: openCreateFileModal, computedFiles } = useProjectFiles(props.project, root)
...
async function fetchContent () {
  ...
  const { content: newContent } = await getFile(file.value.path)
