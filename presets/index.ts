...
const button = {
  variant: {
    ...
    'transparent-hover': 'border border-transparent u-text-gray-500 hover:u-text-white focus:u-text-gray-700 bg-transparent hover:u-bg-gray-900 focus:u-bg-gray-900 disabled:u-text-gray-500'
  }
}
