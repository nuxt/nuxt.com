...
const button = {
  variant: {
    ...
    'transparent-hover': 'border border-transparent u-text-gray-500 hover:u-text-gray-700 focus:u-text-gray-700 bg-transparent hover:u-bg-gray-100 focus:u-bg-gray-100 disabled:u-text-gray-500'
  }
}
