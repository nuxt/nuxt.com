...
Steps to follow:
1. Call \`agent-usage-stats\` with \`sinceDays=${sinceDays}\` for web chat counts and vote totals. For runs/tokens/cost, tell the reader to check Vercel Observability → Agent Runs.
